...
(<?php echo $this->formatPercentage($this->reducedRate); ?>: <?php echo $this->formatCurrency($this->vatReduced); ?> / <?php echo $this->formatPercentage($this->fullRate); ?>: <?php echo $this->formatCurrency($this->vatFull); ?>)
<?php else:?>
