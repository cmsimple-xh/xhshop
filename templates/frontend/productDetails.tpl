	...
	<div class="xhsInfoBlock">
		<form method="post">
			...
			<div class="xhsPrdPrice"><span class="xhsPrdPriceLabel"><?php echo $this->labels['price']; ?><br>
				<?php $this->hint($this->vatInfo); ?> <?php if (!$this->hideVat):?>%VATRATE% %<?php endif?><br><?php echo $this->shippingCostsHint(); ?></span> <span class="xhsPrdPriceNum"><?php echo $this->formatCurrency($this->price); ?></span></div>
