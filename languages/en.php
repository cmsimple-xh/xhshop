...
$plugin_tx['xhshop']['cf_shop_image_folder']="A folder relative to the image folder of CMSimple_XH where the product images are stored. Leave blank to use the image folder directly.";
$plugin_tx['xhshop']['cf_shop_preview_folder']="A folder relative to the image folder of CMSimple_XH where the product preview images are stored. Leave blank to use the image folder directly.";
